...
Do not select first 5 mobiles from the list.Try scrolling and search for the mobile
  ...
  SeleniumLibrary.Execute Javascript  window.scrollTo(0,3000)
  sleep  3s
  SeleniumLibrary.Execute Javascript  window.scrollTo(0,1000)
  sleep  3s
  SeleniumLibrary.Execute Javascript  window.scrollTo(0,1500)
  Sleep  10s
